...
//	JPanel southtPanel;
	...
	public void setElement()
	{
		...
		FiveChessButton = new JButton(new ImageIcon("./image/鈭���.jpg"));
		FiveChessButton.setText("鈭���");
		...
		DarkChessButton = new JButton(new ImageIcon("./image/����.jpg"));
		DarkChessButton.setText("����");
